...
The actual GSD workflow files live in the [get-shit-done](https://github.com/cjplanted/get-shit-done) repo. These examples are extracted snippets showing the MMR integration pattern.
...
```bash
ENGINE=$(node ~/.claude/mmr/router.js resolve <agent-type> <workflow> 2>/dev/null || echo "claude")
```
